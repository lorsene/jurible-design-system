...
C14 - COMPARATIF 5 OFFRES (id="offres")
├── Badge : "Comparatif"
├── Titre : "Nos 5 offres"
...
P05 - AIDE AU CHOIX (id="aide-choix")
├── Badge : "Aide au choix"
...
| H04 | Hero Simple | Hero | ✅ |
| P01 | Paragraphe simple | Intro | ✅ |
| C14 | Pricing Produits Comparatif | Comparatif 5 offres | ✅ |
| P05 | Bloc quelle offre choisir | Aide au choix | ✅ |
| P07 | Pricing Académie + features | Focus Académie | ✅ |
...
1. **C14 Cards offres** : L'Académie a un badge "Offre principale" et un style distinct (border ou fond)
2. **P05 Aide au choix** : Chaque recommandation est cliquable → scroll vers l'offre correspondante
3. **P07 Focus Académie** : Pricing avec 4 durées, badge "Le + populaire" sur 6 mois
4. **C05 Enseignants** : Avatars avec initiales + nom + spécialité
5. **Mobile** : Cards C14 en colonne, pricing P07 en slider horizontal
6. **Tracking GA4** : Events sur clics CTA, sélection formule, FAQ ouverts
...
- **Schema.org** :
  - `Product` pour chaque offre (Académie, Prépas, Fiches PDF, Suite IA, Manuel)
  - `FAQPage` pour la section FAQ
  - `AggregateRating` (4.8/5 Trustpilot)
