...
| **Visuel** | Mockup dashboard idéalisé (style Stripe) — Prototype HTML fourni (`hero-homepage-prototype.html`). Dashboard avec sidebar matières, stats progression, cours en lecture + 3 cards flottantes (QCM, Flashcard, Note 15/20). Animations : parallax souris, scroll-triggered, compteurs animés. À peaufiner avec le dev. |
